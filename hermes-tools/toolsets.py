...
_HERMES_CORE_TOOLS = [
    ...
    # Research tools
    "search_foundational_papers",
    "crawl_citation_graph",
]
...
TOOLSETS = {
    ...
    "research": {
        "description": "OpenAlex citation crawling and prior-art mapping tools",
        "tools": ["search_foundational_papers", "crawl_citation_graph"],
        "includes": []
    },
